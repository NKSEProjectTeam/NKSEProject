...
<link href="jsp/css/postcss/style.css" media="screen"
	rel="stylesheet" type="text/css">
<link href="jsp/css/postcss/grid.css" media="screen"
	rel="stylesheet" type="text/css">
	...
	<div class="container_12">
		...
		<div id="content" class="grid_9">
			...
			<c:if test="${empty requestScope.lstItems }">
				...
				<script>window.location="/Exchange/FindAllItemServlet?id="+1;
	</script>
			</c:if>
			...
			<c:forEach items="${requestScope.lstItems }" var="items">
				<div class="grid_product">
					<div class="grid_3 product">
						...
						<!-- .prev -->
						<h3 class="title">音像名称：${items.audioname} &nbsp
							出版社：${items.audiopublish }&nbsp &nbsp发布时间:${items.posttime}</h3>
						<div class="cart">
							<div class="price">
								<div class="vert">
