	...
	<div class="container_12">
		...
		<div id="content" class="grid_9">
			...
			<c:if test="${empty requestScope.lstItems }">
				...
				<script>window.location="/Exchange/FindAllItemServlet?id="+20;
	</script>
			</c:if>
			...
			<c:forEach items="${requestScope.lstItems }" var="items">
				<div class="grid_product">
					<div class="grid_3 product">
						...
						<!-- .prev -->
						<h3 class="title">名称：${items.spname} &nbsp 类型：${items.sptype
							} &nbsp 产地：${items.splocation } &nbsp &nbsp发布时间:${items.posttime}</h3>
						<div class="cart">
							<div class="price">
								<div class="vert">
