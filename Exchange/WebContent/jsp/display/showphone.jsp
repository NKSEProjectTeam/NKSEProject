	...
	<div class="container_12">
		...
		<div id="content" class="grid_9">
			...
			<c:if test="${empty requestScope.lstItems }">
				...
				<script>window.location="/Exchange/FindAllItemServlet?id="+12;
	</script>
			</c:if>
			...
			<c:forEach items="${requestScope.lstItems }" var="items">
				<div class="grid_product">
					<div class="grid_3 product">
						...
						<!-- .prev -->
						<h3 class="title">品牌：${items.phonebrand} &nbsp
							型号：${items.phonemodel} &nbsp 类型：${items.phonetype } &nbsp
							&nbsp发布时间:${items.posttime}</h3>
						<div class="cart">
							<div class="price">
								<div class="vert">
