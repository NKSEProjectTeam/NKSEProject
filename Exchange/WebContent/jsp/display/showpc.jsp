	...
	<div class="container_12">
		...
		<div id="content" class="grid_9">
			...
			<c:if test="${empty requestScope.lstItems }">
				...
				<script>window.location="/Exchange/FindAllItemServlet?id="+11;
	</script>
			</c:if>
			...
			<c:forEach items="${requestScope.lstItems }" var="items">
				<div class="grid_product">
					<div class="grid_3 product">
						...
						<!-- .prev -->
						<h3 class="title">类型：${items.pctype}&nbsp 品牌：${items.pcbrand
							}&nbsp型号：${items.pcmodel }&nbsp &nbsp发布时间:${items.posttime}</h3>
						<div class="cart">
							<div class="price">
								<div class="vert">
