...
<body>
	...
	<div class="container_12">
		<div id="sidebar" class="grid_3">
			...
			<aside id="tags">
			<h3>标签</h3>
			<a class="t1" href="#">california</a> <a class="t2" href="#">canada</a>
			<a class="t3" href="#">canon</a> <a class="t4" href="#">cat</a> <a
				class="t5" href="#">chicago</a> <a class="t6" href="#">christmas</a>
			<a class="t7" href="#">mars</a> <a class="t8" href="#">church</a> <a
				class="t9" href="#">city</a> <a class="t10" href="#">clouds</a> <a
				class="t11" href="#">color</a> <a class="t12" href="#">concert</a> <a
				class="t13" href="#">dance</a> <a class="t14" href="#">day</a> <a
				class="t15" href="#">dog</a> <a class="t16" href="#">england</a> <a
				class="t17" href="#">europe</a> </aside>
			<!-- #tags -->
